...
.navbar-default .navbar-brand, .navbar-default .navbar-brand:hover {
				...
				<div class="col-md-4">
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							<form id="tab" action="verifyNewPhone.action" method="post">
								<div class="form-group">
									<label>请输入新的电话号码</label> <input type="text" id="newPhoneNum"  name="newPhoneNum"
										class="form-control">
								</div>
	...
	<script type="text/javascript">
		...
		function getVerify(){
			if($('#newPhoneNum').val()=="" || !$('#newPhoneNum').val().match(/^((13[0-9])|(15[^4,\\D])|(18[0,0-9]))\d{8}$/)){
				alert("请输入正确格式的手机号码！");
			}else{
			...
			$.ajax({
			    ...
			    if(data=="success"){
			    		$('#newPhoneNum').attr("readonly",true);
					    setTimeout(function(){settime() },1000);
				    }else{
				    	alert("程序异常，请联系我们！");
				    }

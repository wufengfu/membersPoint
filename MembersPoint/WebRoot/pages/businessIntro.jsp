	...
	<div class="navbar navbar-default" role="navigation">
		<div class="navbar-header">
			<a class="" href="#"><span class="navbar-brand"><span
					class="fa fa-paper-plane"></span>弗恩天下</span></a>
		</div>
		<div class="navbar-collapse collapse" style="height: 1px;"></div>
	</div>
	<div class="main">
			<div class="panel panel-default">
	            <a href="#widget1container" class="panel-heading" data-toggle="collapse">业务介绍 </a>
	            <div id="widget1container" class="panel-body collapse in">
	            	<h2>弗恩天下</h2>
	            	<p>目前已经形成 三大业务集群</p>
	            </div>
	        </div>
		<s:iterator var="util" value="systemUtil" status="ser">
			<div class="panel panel-default">
				<a href="#widgetcontainer<s:property value="#ser.count" />"
					class="panel-heading" data-toggle="collapse">业务<s:property value="#ser.count" /></a>
				<div id="widgetcontainer<s:property value="#ser.count" />"
					class="panel-body collapse in">
					<s:property value="#util.content" escapeHtml="false" />
				</div>
			</div>
		</s:iterator>
	</div>
